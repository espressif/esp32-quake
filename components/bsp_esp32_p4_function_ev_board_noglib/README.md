> :warning: This is **No Graphical Library version** of esp32_p4_function_ev_board BSP. If you want to use this BSP with LVGL use [esp32_p4_function_ev_board](https://components.espressif.com/components/espressif/esp32_p4_function_ev_board) component.
